export const locations = {
    //this is an example of how the api looks in google when we are retrieving data for a place. 
  antwerp: {
    results: [
      {
          // this allows us to find the city
        geometry: {
          location: {
            lng: 4.402464,
            lat: 51.219448,
          },
          // this allows the rendering of the map view so we can spot the location we want. 
          viewport: {
            northeast: {
